...
class Simulation:
    ...
    def animate_c_types(self,
        ...
        plot.animate(self.x_save, self.phi_save,
                     self.t.mesh.L, self.dt, self.tskip,
    ...
    def animate_property(self, tissue_property="dA", cmap=plt.cm.plasma, n_frames=20, file_name=None, dir_name=None,
        ...
        if vmid is None:
            ...
            if vmid < pvmin:
                print("Mid value less than the calculated min. Proceeding anyway... ")
